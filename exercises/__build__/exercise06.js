...
/***/ function(module, exports, __webpack_require__) {
	...
	var RepoList = function (_Component) {
	  ...
	  _createClass(RepoList, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      (0, _axios2.default)('https://api.github.com/users/' + this.props.user + '/repos?per_page=250').then(function (response) {
	        _this2.setState({
	          repos: response.data
	        });
	      });
	...
	_reactDom2.default.render(_react2.default.createElement(RepoList, { user: 'mzabriskie' }), container);
